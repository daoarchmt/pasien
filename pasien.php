                ...
                <table class="table table-striped table-hover table-sm">
                    ...
                    while ($row = $hasil->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td><a href="editpasien.php?edit=<?= $row['idPasien']; ?>" class="btn btn-warning btn-sm">Edit</a> <a href="koneksi.php?idPasien=<?= $row['idPasien']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Ciee mau di Hapus?')">Hapus</a></td>
                        </tr>
                    <?php } ?>
                </table>
            </div>
